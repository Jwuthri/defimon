...
import logo_pokemon from '../../assets/images/logo/logo_pokemon.png'
                        ...
                        <div className="col-lg-3 col-md-10 col-10">
                            <div className="widget widget-logo">
                                <div className="logo-footer" id="logo-footer">
                                    <Link to="/">
                                        <img className='logo-dark' id="logo_footer" src={logo_pokemon} alt="nft-gaming" />
                                        <img className='logo-light' id="logo_footer" src={logo_pokemon} alt="nft-gaming" />

                                    </Link>
                                </div>
                                <p className="sub-widget-logo">Buy Defimon nft, improve them, train them and make them fight</p>
                            </div>
                        </div>
